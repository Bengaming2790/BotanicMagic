...
public class EarthEffect implements Spell {
    ...
    private void spawnProjectile(Level level, LivingEntity caster) {
        SpellProjectileEntity projectile = new SpellProjectileEntity(ModEntities.SPELL_PROJECTILE, level, 0xFF5500,new BlockParticleOption(ParticleTypes.BLOCK, Blocks.MUD.defaultBlockState()));
