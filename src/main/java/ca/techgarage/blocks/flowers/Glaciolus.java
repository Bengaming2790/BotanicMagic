...
public class Glaciolus extends GrowableFlowerBlock implements IExtractableFlower {
    private boolean fullygrown = false;
    public Glaciolus(BlockBehaviour.Properties properties) {
    ...
    private static final FlowerExtractionData EXTRACTION_DATA = new FlowerExtractionData(
            0.30f,  // 30% - Ice element
            0.15f,  // 15% - shape
            0.25f,  // 25% - husk
            // Remaining 40% - FAILED
            List.of(new FlowerExtractionData.WeightedEntry<>(SpellElement.ICE, 1.0f)),
            List.of(
