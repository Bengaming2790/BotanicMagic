...
public class Holyhock extends GrowableFlowerBlock implements IExtractableFlower {
    private boolean fullygrown = false;
    public Holyhock(Properties properties) {
    ...
    private static final FlowerExtractionData EXTRACTION_DATA = new FlowerExtractionData(
            ...
            0.25f,  // 35% - husk
            // Remaining 47% - FAILED
            List.of(new FlowerExtractionData.WeightedEntry<>(SpellElement.LIGHT, 1.0f)),
            List.of(
