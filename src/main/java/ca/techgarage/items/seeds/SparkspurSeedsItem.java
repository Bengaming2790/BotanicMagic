...
public class SparkspurSeedsItem extends Item {

    public SparkspurSeedsItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        BlockState plantState = ModBlocks.SPARKSPUR.defaultBlockState()
