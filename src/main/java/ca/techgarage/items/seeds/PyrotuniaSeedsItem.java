...
public class PyrotuniaSeedsItem extends Item {

    public PyrotuniaSeedsItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        BlockState plantState = ModBlocks.PYROTUNIA.defaultBlockState()
